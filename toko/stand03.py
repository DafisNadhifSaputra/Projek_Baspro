...
class stand03:
    ...
    def load_products(self):
        """Load produk dari data_produk/stand03.json"""
        try:
            with open("data_produk/stand03.json", "r") as f:
                return json.load(f)
        except FileNotFoundError:
            messagebox.showerror("Error", "data_produk/stand03.json tidak ada!")
            return {}
        except json.JSONDecodeError:
            messagebox.showerror("Error", "Error decoding data_produk/stand03.json!")
            return {}

    def create_widgets(self):
        """Membuat widget untuk aplikasi"""
    ...
    def kembali_ke_pilih_kedai(self):
        """Kembali ke halaman pemilihan kedai"""
        self.root.destroy()
    ...
    def checkout(self):
        ...
        with open("data_produk/stand03.json", "w") as f:
