...
class stand05:
    ...
    def load_products(self):
        ...
        try:
            ...
            messagebox.showerror("Error", "data_produk/stand05.json file not found!")
            return {}
        except json.JSONDecodeError:
            messagebox.showerror("Error", "Error decoding data_produk/stand05.json!")
            return {}
