...
class elfood:
    ...
    def load_products(self):
        """Load products from data_produk/elfood.json"""
        try:
            with open("data_produk/elfood.json", "r") as f:
                return json.load(f)
        except FileNotFoundError:
            messagebox.showerror("Error", "data_produk/elfood.json file not found!")
            return {}
        except json.JSONDecodeError:
            messagebox.showerror("Error", "Error decoding data_produk/elfood.json!")
            return {}
    ...
    def checkout(self):
        ...
        with open("data_produk/elfood.json", "w") as f:
